...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , get_inputs_s{vlSymsp->TOP.get_inputs_s}
    , EN_get_inputs{vlSymsp->TOP.EN_get_inputs}
    , RDY_get_inputs{vlSymsp->TOP.RDY_get_inputs}
    , RDY_mac_op{vlSymsp->TOP.RDY_mac_op}
    , get_inputs_a{vlSymsp->TOP.get_inputs_a}
    , get_inputs_b{vlSymsp->TOP.get_inputs_b}
    , get_inputs_c{vlSymsp->TOP.get_inputs_c}
    , mac_op{vlSymsp->TOP.mac_op}
    , rootp{&(vlSymsp->TOP)}
{
